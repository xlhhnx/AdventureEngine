...
using AdventureEngine.AudioManagement.Loading;
using AdventureEngine.AudioManagement.Players;
using AdventureEngine.Messaging;
using System.Collections.Generic;

namespace AdventureEngine.AudioManagement.Managers
{
    public class AudioManager
    {
        ...
        {
            if (audio is Song)
                AddAudio(audio as Song, overwrite);
            else if (audio is Sound)
                AddAudio(audio as Sound, overwrite);
        }
