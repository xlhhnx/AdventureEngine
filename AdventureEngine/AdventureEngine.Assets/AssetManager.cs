    ...
    public class AssetManager : IAssetManager
    {
        ...
        public void LoadAsset(string filePath, string id, IAssetBatch batch)
        {
            ...
            if (asset is AudioAsset)
                AddAsset(asset as AudioAsset, true);
            else if (asset is SpriteFontAsset)
                AddAsset(asset as SpriteFontAsset, true);
            else if (asset is Texture2DAsset)
                AddAsset(asset as Texture2DAsset, true);
        }
